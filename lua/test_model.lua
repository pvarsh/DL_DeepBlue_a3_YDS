...
function main(opt)
    ...
    print("Loading model")
    local model = torch.load("baseline_49.2.net")
...
if not opt then
   ...
   cmd:option('-inputDim', 300, 'word vector dimension: [50 | 100 | 200 | 300]')
   ...
   cmd:option('-nTrainDocs', 100, 'number of training documents in each class')
